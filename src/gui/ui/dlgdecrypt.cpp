...
//                    {
//                        const int32_t nym_count = ot.Exec().GetNymCount();
//                        // -----------------------------------------------
//                        for (int32_t ii = 0; ii < nym_count; ++ii)
//                        {
//                            //Get OT Nym ID
//                            QString OT_nym_id = QString::fromStdString(ot.Exec().GetNym_ID(ii));
...
//                            std::shared_ptr<const opentxs::Nym> pNym = ot.Wallet().Nym(id_signer_nym);
//                            if (false != bool(pNym))
//                            {
...
//                    qstrNymWhoDecryptedName = QString::fromStdString(ot.Exec().GetNym_Name(qstrNymWhoDecrypted.toStdString()));
//                if (!qstrNymWhoVerified.isEmpty())
//                    qstrNymWhoVerifiedName = QString::fromStdString(ot.Exec().GetNym_Name(qstrNymWhoVerified.toStdString()));
//                // -------------------------------
